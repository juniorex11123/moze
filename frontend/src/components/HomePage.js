      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Śledzenie Czasu</h3>
            <p className="text-gray-600">Dokładne rejestrowanie czasu pracy pracowników z wykorzystaniem kodów QR.</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Zarządzanie Zespołem</h3>
            <p className="text-gray-600">Kompleksowe zarządzanie pracownikami i ich danymi w systemie.</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Raporty</h3>
            <p className="text-gray-600">Szczegółowe raporty dotyczące czasu pracy i produktywności.</p>
          </div>
        </div>
